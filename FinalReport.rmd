...
1. Is the vaccine effective for drug users? 2. Is the the vaccine effective for women?
...
-->
The null hypothesis is rejected due to the p-value being less than 0.05, which is 0.0000000423 as shown in the fisher test. The is significant difference between drug users and women for those who get the vaccine and contracted AIDS.
